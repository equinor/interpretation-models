...
def ow_to_sid(
    ...
    Args:
        ...
        pipeline_metadata: Pipeline metadata object
    ...
    def convert_date_to_utc(
        ...
        pass  # TODO: implement date conversion to UTC based on the timezone from Project table
    ...
    source_metadata = SourceMetadata(
        ...
        create_date_utc=convert_date_to_utc(
            ...
            pipeline_metadata.project.timezone
            if pipeline_metadata and pipeline_metadata.project
            else None,
        ),
