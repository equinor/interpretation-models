...
def test_convert_date_to_utc_normal_time():
    ...
    result = _convert_date_to_utc(local_date, timezone="Europe/Oslo")
...
def test_localize_date_daylight_saving():
    ...
    result = _localize_date(naive_date, timezone="Europe/Oslo")
...
def test_source_metadata_localized_dates_json():
    ...
    source_metadata = SourceMetadata(
        ...
        name="test_surface",
        create_user="user1",
        create_date=_localize_date(naive_date, timezone),
        create_date_utc=_convert_date_to_utc(naive_date, timezone),
    )
